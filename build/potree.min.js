...
Potree.updateVisibility=function(a,b,c){var d=0,e=new Map(a.map(function(a){return[a,0]})),f=[],g=[],h=[],l=Infinity,k=Potree.updateVisibilityStructures(a,b,c),m=k.frustums,n=k.camObjPositions;k=k.priorityQueue;var p=0;c=c.domElement.clientHeight;Potree._pointcloudTransformVersion||(Potree._pointcloudTransformVersion=new Map);for(var w=Potree._pointcloudTransformVersion,r=$jscomp.makeIterator(a),q=r.next();!q.done;q=r.next())if(q=q.value,q.visible)if(q.updateMatrixWorld(),w.has(q)){var u=w.get(q);
u.transform.equals(q.matrixWorld)||(u.number++,u.transform.copy(q.matrixWorld),q.dispatchEvent({type:'transformation_changed',target:q}))}else w.set(q,{number:0,transform:q.matrixWorld.clone()});for(;0<k.size();){r=k.pop();q=r.node;var z=r.parent;u=a[r.pointcloud];var A=q.getBoundingBox(),t=n[r.pointcloud],v=m[r.pointcloud].intersectsBox(A);A=u.maxLevel||Infinity;var y=q.getLevel();v=(v=(v=v&&!(d+q.getNumPoints()>Potree.pointBudget))&&!(e.get(u)+q.getNumPoints()>u.pointBudget))&&y<A;q.spacing?l=Math.min(l,
q.spacing):q.geometryNode&&q.geometryNode.spacing&&(l=Math.min(l,q.geometryNode.spacing));if(d+q.getNumPoints()>Potree.pointBudget)break;if(v)for(d+=q.getNumPoints(),A=e.get(u),e.set(u,A+q.getNumPoints()),u.numVisibleNodes++,u.numVisiblePoints+=q.getNumPoints(),!q.isGeometryNode()||z&&!z.isTreeNode()||(q.isLoaded()&&2>p?(q=u.toTreeNode(q,z),p++):(h.push(q),g.push(q))),q.isTreeNode()&&(Potree.getLRU().touch(q.geometryNode),q.sceneNode.visible=!0,q.sceneNode.material=u.material,f.push(q),u.visibleNodes.push(q),
...
!u.showBoundingBox&&q.boundingBoxNode&&(q.boundingBoxNode.visible=!1)),z=q.getChildren(),A=0;A<z.length;A++){y=z[A];var x=0;if(b.isPerspectiveCamera){v=y.getBoundingSphere(new THREE.Sphere);var B=v.center,C=t.x-B.x;x=t.y-B.y;B=t.z-B.z;C=Math.sqrt(C*C+x*x+B*B);v=v.radius;x=.5*c/(Math.tan(b.fov*Math.PI/180/2)*C)*v;if(x<u.minimumNodePixelSize)continue;0>C-v&&(x=Number.MAX_VALUE)}else v=y.getBoundingBox(),C=y.getBoundingSphere(new THREE.Sphere).center.distanceTo(t),x=v.max.clone().sub(v.min).length()/
C;k.push({pointcloud:r.pointcloud,node:y,parent:q,weight:x})}}a=a.filter(function(a){return a.generateDEM&&a.dem instanceof Potree.DEM});a=$jscomp.makeIterator(a);for(q=a.next();!q.done;q=a.next())b=q.value,e=b.visibleNodes.filter(function(a){return 4>=a.getLevel()}),b.dem.update(e);for(a=0;a<Math.min(Potree.maxNodesLoading,h.length);a++)h[a].load();return{visibleNodes:f,numVisiblePoints:d,lowestSpacing:l}};
...
lib$potree$potree_nogui$classdecl$var1.prototype.setUniformMatrix4=function(a,b){var c=this.gl;a=this.uniformLocations[a];null!=a&&(b=new Float32Array(b.elements),c.uniformMatrix4fv(a,!1,b))};lib$potree$potree_nogui$classdecl$var1.prototype.setUniform1f=function(a,b){a=this.uniformLocations[a];null!=a&&this.gl.uniform1f(a,b)};lib$potree$potree_nogui$classdecl$var1.prototype.setUniformBoolean=function(a,b){a=this.uniformLocations[a];null!=a&&this.gl.uniform1i(a,b)};
lib$potree$potree_nogui$classdecl$var1.prototype.setUniformTexture=function(a,b){a=this.uniformLocations[a];null!=a&&this.gl.uniform1i(a,b)};lib$potree$potree_nogui$classdecl$var1.prototype.setUniform2f=function(a,b){a=this.uniformLocations[a];null!=a&&this.gl.uniform2f(a,b[0],b[1])};lib$potree$potree_nogui$classdecl$var1.prototype.setUniform3f=function(a,b){a=this.uniformLocations[a];null!=a&&this.gl.uniform3f(a,b[0],b[1],b[2])};
lib$potree$potree_nogui$classdecl$var1.prototype.setUniform=function(a,b){b.constructor===THREE.Matrix4?this.setUniformMatrix4(a,b):'number'===typeof b?this.setUniform1f(a,b):'boolean'===typeof b?this.setUniformBoolean(a,b):b instanceof Potree.WebGLTexture?this.setUniformTexture(a,b):b instanceof Array?2===b.length?this.setUniform2f(a,b):3===b.length&&this.setUniform3f(a,b):console.error('unhandled uniform type: ',a,b)};
lib$potree$potree_nogui$classdecl$var1.prototype.setUniform1i=function(a,b){a=this.uniformLocations[a];null!=a&&this.gl.uniform1i(a,b)};Potree.Shader=lib$potree$potree_nogui$classdecl$var1;var lib$potree$potree_nogui$classdecl$var2=function(a,b){this.gl=a;this.texture=b;this.id=a.createTexture();this.target=a.TEXTURE_2D;this.version=-1;this.update(b)};
lib$potree$potree_nogui$classdecl$var2.prototype.update=function(){if(this.texture.image){var a=this.gl,b=this.texture;if(this.version!==b.version){this.target=a.TEXTURE_2D;a.bindTexture(this.target,this.id);var c=Potree.paramThreeToGL(a,b.format),d=b.image.width,e=b.image.height,f=Potree.paramThreeToGL(a,b.type);a.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,b.flipY);a.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha);a.pixelStorei(a.UNPACK_ALIGNMENT,b.unpackAlignment);if(b instanceof THREE.DataTexture){var g=
...
a.TEXTURE_WRAP_T,Potree.paramThreeToGL(a,b.wrapT)),a.texParameteri(this.target,a.TEXTURE_MAG_FILTER,Potree.paramThreeToGL(a,b.magFilter)),a.texParameteri(this.target,a.TEXTURE_MIN_FILTER,Potree.paramThreeToGL(a,b.minFilter)),a.texImage2D(this.target,0,c,c,f,g));a.bindTexture(this.target,null);this.version=b.version}}else this.version=this.texture.version};Potree.WebGLTexture=lib$potree$potree_nogui$classdecl$var2;
var lib$potree$potree_nogui$classdecl$var3=function(){this.numElements=0;this.vao=null;this.vbos=new Map};Potree.WebGLBuffer=lib$potree$potree_nogui$classdecl$var3;var lib$potree$potree_nogui$classdecl$var4=function(a,b,c){this.name=a;this.box=b;this.tileSize=c;this.level=this.name.length-1;this.data=new Float32Array(c*c);this.data.fill(-Infinity);this.children=[];this.mipMap=[this.data];this.mipMapNeedsUpdate=!0};
lib$potree$potree_nogui$classdecl$var4.prototype.createMipMap=function(){this.mipMap=[this.data];for(var a=this.tileSize,b=parseInt(a/2),c=this.data;1<b;){for(var d=new Float32Array(b*b),e=0;e<b;e++)for(var f=0;f<b;f++){var g=c[2*e+2*f*a],h=c[2*e+2*f*a+a],l=c[2*e+1+2*f*a],k=c[2*e+1+2*f*a+a],m=$jscomp.makeIterator([0,0]),n=m.next().value;m=m.next().value;isFinite(g)&&(n+=g,m+=1);isFinite(h)&&(n+=h,m+=1);isFinite(l)&&(n+=l,m+=1);isFinite(k)&&(n+=k,m+=1);n/=m;d[e+f*b]=n}this.mipMap.push(d);c=d;a=b;b=
parseInt(b/2)}this.mipMapNeedsUpdate=!1};lib$potree$potree_nogui$classdecl$var4.prototype.uv=function(a){var b=this.box.getSize(new THREE.Vector3);return[(a.x-this.box.min.x)/b.x,(a.y-this.box.min.y)/b.y]};
lib$potree$potree_nogui$classdecl$var4.prototype.heightAtMipMapLevel=function(a,b){a=this.uv(a);var c=parseInt(this.tileSize/parseInt(Math.pow(2,b))),d=this.mipMap[b],e=Math.min(a[0]*c,c-1),f=Math.min(a[1]*c,c-1);a=e%1;b=f%1;var g=$jscomp.makeIterator([Math.floor(e),Math.ceil(e)]);e=g.next().value;var h=g.next().value;f=$jscomp.makeIterator([Math.floor(f),Math.ceil(f)]);g=f.next().value;var l=f.next().value;f=d[e+c*g];e=d[e+c*l];g=d[h+c*g];c=d[h+c*l];d=isFinite(f)?(1-a)*(1-b):0;h=isFinite(e)?(1-a)*
b:0;l=isFinite(g)?a*(1-b):0;a=isFinite(c)?a*b:0;b=d+h+l+a;d/=b;h/=b;l/=b;a/=b;if(0===b)return null;b=0;isFinite(f)&&(b+=f*d);isFinite(e)&&(b+=e*h);isFinite(g)&&(b+=g*l);isFinite(c)&&(b+=c*a);return b};lib$potree$potree_nogui$classdecl$var4.prototype.height=function(a){for(var b=null,c=0;c<this.mipMap.length&&(b=this.heightAtMipMapLevel(a,c),null===b);c++);return b};
lib$potree$potree_nogui$classdecl$var4.prototype.traverse=function(a,b){b=void 0===b?0:b;a(this,b);for(var c=$jscomp.makeIterator(this.children.filter(function(a){return void 0!==a})),d=c.next();!d.done;d=c.next())d.value.traverse(a,b+1)};Potree.DEMNode=lib$potree$potree_nogui$classdecl$var4;var lib$potree$potree_nogui$classdecl$var5=function(a){this.pointcloud=a;this.boundingBox=this.matrix=null;this.tileSize=64;this.root=null;this.version=0};
lib$potree$potree_nogui$classdecl$var5.prototype.expandAndFindByBox=function(a,b){if(0===b)return[this.root];for(var c=[],d=[this.root];0<d.length;){var e=d.pop(),f=e.box.getSize(new THREE.Vector3),g=(a.min.x-e.box.min.x)/f.x,h=(a.min.y-e.box.min.y)/f.y,l=(a.max.x-e.box.max.x)/f.x,k=(a.max.y-e.box.max.y)/f.y;g=.5>g?0:1;h=.5>h?0:1;l=.5>l?0:1;k=.5>k?0:1;g=$jscomp.makeIterator(0===g&&0===h&&1===l&&1===k?[0,1,2,3]:g===l&&h===k?[g<<1|h]:[g<<1|h,l<<1|k]);for(h=g.next();!h.done;h=g.next())h=h.value,void 0===
e.children[h]&&(l=e.box.clone(),0<(h&2)?l.min.x+=f.x/2:l.max.x-=f.x/2,0<(h&1)?l.min.y+=f.y/2:l.max.y-=f.y/2,l=new Potree.DEMNode(e.name+h,l,this.tileSize),e.children[h]=l),h=e.children[h],h.level<b?d.push(h):c.push(h)}return c};lib$potree$potree_nogui$classdecl$var5.prototype.childIndex=function(a){var b=$jscomp.makeIterator(a.map(function(a){return.5>a?0:1}));a=b.next().value;b=b.next().value;return a<<1|b};
lib$potree$potree_nogui$classdecl$var5.prototype.height=function(a){if(!this.root)return 0;for(var b=null,c=[this.root];;){var d=c[c.length-1],e=d.height(a);null!==e&&(b=e);e=d.uv(a);e=this.childIndex(e);if(d.children[e])c.push(d.children[e]);else break}return b+this.pointcloud.position.z};
lib$potree$potree_nogui$classdecl$var5.prototype.update=function(a){var b=this;if(!Potree.getDEMWorkerInstance().working){null!==this.matrix&&this.matrix.equals(this.pointcloud.matrixWorld)||(this.matrix=this.pointcloud.matrixWorld.clone(),this.boundingBox=this.pointcloud.boundingBox.clone().applyMatrix4(this.matrix),this.root=new Potree.DEMNode('r',this.boundingBox,this.tileSize),this.version++);var c=null;a=$jscomp.makeIterator(a);for(var d=a.next();!d.done;d=a.next())if(d=d.value,void 0===d.demVersion||
d.demVersion<this.version){c=d;break}if(null!==c){var e=c.getBoundingBox().clone().applyMatrix4(this.matrix),f=e.getSize(new THREE.Vector3),g=this.expandAndFindByBox(e,c.getLevel());c.demVersion=this.version;Potree.getDEMWorkerInstance().onmessage=function(a){a=new Float32Array(a.data.dem.data);for(var c=$jscomp.makeIterator(g),d=c.next();!d.done;d=c.next()){d=d.value;for(var h=d.box.getSize(new THREE.Vector3),n=0;n<b.tileSize;n++)for(var p=0;p<b.tileSize;p++){var w=b.tileSize*(d.box.min.x+n/(b.tileSize-
1)*h.x-e.min.x)/f.x,r=b.tileSize*(d.box.min.y+p/(b.tileSize-1)*h.y-e.min.y)/f.y;0>w||w>b.tileSize||0>r||r>b.tileSize||(w=Math.min(Math.floor(w),b.tileSize-1),r=Math.min(Math.floor(r),b.tileSize-1),d.data[n+b.tileSize*p]=a[w+b.tileSize*r])}d.createMipMap();d.mipMapNeedsUpdate=!0;Potree.getDEMWorkerInstance().working=!1}};a=c.geometryNode.geometry.attributes.position.array;c={boundingBox:{min:c.getBoundingBox().min.toArray(),max:c.getBoundingBox().max.toArray()},position:(new Float32Array(a)).buffer};
a=[c.position];Potree.getDEMWorkerInstance().working=!0;Potree.getDEMWorkerInstance().postMessage(c,a)}}};Potree.DEM=lib$potree$potree_nogui$classdecl$var5;Potree.PointCloudTreeNode=function(){this.needsTransformUpdate=!0};Potree.PointCloudTreeNode.prototype.getChildren=function(){throw Error('override function');};Potree.PointCloudTreeNode.prototype.getBoundingBox=function(){throw Error('override function');};
...
Potree.numNodesLoading--};b={buffer:b,pointAttributes:c,version:this.version.version,min:[a.boundingBox.min.x,a.boundingBox.min.y,a.boundingBox.min.z],offset:[a.pcoGeometry.offset.x,a.pcoGeometry.offset.y,a.pcoGeometry.offset.z],scale:this.scale,spacing:a.spacing,hasChildren:a.hasChildren,name:a.name};f.postMessage(b,[b.buffer])};Potree.BinaryLoader=lib$potree$potree_nogui$classdecl$var8;
...
pointFormatID:2,scale:a.scale,offset:a.offset,mins:a.mins,maxs:a.maxs};d.postMessage(e,[e.buffer])};Potree.LasLazBatcher=lib$potree$potree_nogui$classdecl$var10;
...
lib$potree$potree_nogui$classdecl$var11.prototype.setClipBoxes=function(a){if(a){var b=this.clipBoxes.length!==a.length&&(0===a.length||0===this.clipBoxes.length);this.uniforms.clipBoxCount.value=this.clipBoxes.length;this.clipBoxes=a;b&&this.updateShaderSource();this.uniforms.clipBoxes.value=new Float32Array(16*this.clipBoxes.length);for(b=0;b<this.clipBoxes.length;b++)this.uniforms.clipBoxes.value.set(a[b].inverse.elements,16*b);for(a=0;a<this.uniforms.clipBoxes.value.length;a++)Number.isNaN(this.uniforms.clipBoxes.value[a])&&
(this.uniforms.clipBoxes.value[a]=Infinity)}};lib$potree$potree_nogui$classdecl$var11.prototype.setClipPolygons=function(a,b){a&&(this.clipPolygons=a,this.clipPolygons.length!==a.length&&this.updateShaderSource())};
lib$potree$potree_nogui$classdecl$var11.prototype.recomputeClassification=function(){this.classificationTexture=Potree.PointCloudMaterial.generateClassificationTexture(this._classification);this.uniforms.classificationLUT.value=this.classificationTexture;this.dispatchEvent({type:'material_property_changed',target:this})};
lib$potree$potree_nogui$classdecl$var11.generateGradientTexture=function(a){var b=document.createElement('canvas');b.width=64;b.height=64;var c=b.getContext('2d');c.rect(0,0,64,64);for(var d=c.createLinearGradient(0,0,64,64),e=0;e<a.length;e++){var f=a[e];d.addColorStop(f[0],'#'+f[1].getHexString())}c.fillStyle=d;c.fill();a=new THREE.CanvasTexture(b);a.needsUpdate=!0;a.minFilter=THREE.LinearFilter;return a};
lib$potree$potree_nogui$classdecl$var11.generateClassificationTexture=function(a){for(var b=new Uint8Array(262144),c=0;256>c;c++)for(var d=0;256>d;d++){var e=c+256*d;var f=a[c]?a[c]:a[c%32]?a[c%32]:a.DEFAULT;b[4*e]=255*f.x;b[4*e+1]=255*f.y;b[4*e+2]=255*f.z;b[4*e+3]=255*f.w}a=new THREE.DataTexture(b,256,256,THREE.RGBAFormat);a.magFilter=THREE.NearestFilter;a.needsUpdate=!0;return a};
lib$potree$potree_nogui$classdecl$var11.prototype.disableEvents=function(){void 0===this._hiddenListeners&&(this._hiddenListeners=this._listeners,this._listeners={})};lib$potree$potree_nogui$classdecl$var11.prototype.enableEvents=function(){this._listeners=this._hiddenListeners;this._hiddenListeners=void 0};lib$potree$potree_nogui$classdecl$var11.prototype.copyFrom=function(a){for(var b=$jscomp.makeIterator(this.uniforms),c=b.next();!c.done;c=b.next())c=c.value,this.uniforms[c].value=a.uniforms[c].value};
$jscomp.global.Object.defineProperties(lib$potree$potree_nogui$classdecl$var11.prototype,{gradient:{configurable:!0,enumerable:!0,get:function(){return this._gradient},set:function(a){this._gradient!==a&&(this._gradient=a,this.gradientTexture=Potree.PointCloudMaterial.generateGradientTexture(this._gradient),this.uniforms.gradient.value=this.gradientTexture)}},useOrthographicCamera:{configurable:!0,enumerable:!0,get:function(){return this.uniforms.useOrthographicCamera.value},set:function(a){this.uniforms.useOrthographicCamera.value!==
...
set:function(a){this.uniforms.wReturnNumber.value!==a&&(this.uniforms.wReturnNumber.value=a,this.dispatchEvent({type:'material_property_changed',target:this}))}},weightSourceID:{configurable:!0,enumerable:!0,get:function(){return this.uniforms.wSourceID.value},set:function(a){this.uniforms.wSourceID.value!==a&&(this.uniforms.wSourceID.value=a,this.dispatchEvent({type:'material_property_changed',target:this}))}}});Potree.PointCloudMaterial=lib$potree$potree_nogui$classdecl$var11;
var lib$potree$potree_nogui$classdecl$var12=function(a){a=THREE.ShaderMaterial.call(this)||this;a.setValues({uniforms:{screenWidth:{type:'f',value:0},screenHeight:{type:'f',value:0},edlStrength:{type:'f',value:1},radius:{type:'f',value:1},neighbours:{type:'2fv',value:[]},depthMap:{type:'t',value:null},uRegularColor:{type:'t',value:null},uRegularDepth:{type:'t',value:null},uEDLColor:{type:'t',value:null},uEDLDepth:{type:'t',value:null},opacity:{type:'f',value:1}},vertexShader:a.getDefines()+Potree.Shaders['edl.vs'],
fragmentShader:a.getDefines()+Potree.Shaders['edl.fs'],lights:!1});a.neighbourCount=8;return a};$jscomp.inherits(lib$potree$potree_nogui$classdecl$var12,THREE.ShaderMaterial);lib$potree$potree_nogui$classdecl$var12.prototype.getDefines=function(){return'#define NEIGHBOUR_COUNT '+this.neighbourCount+'\n'};
lib$potree$potree_nogui$classdecl$var12.prototype.updateShaderSource=function(){var a=this.getDefines()+Potree.Shaders['edl.vs'],b=this.getDefines()+Potree.Shaders['edl.fs'];this.setValues({vertexShader:a,fragmentShader:b});this.uniforms.neighbours.value=this.neighbours;this.needsUpdate=!0};
$jscomp.global.Object.defineProperties(lib$potree$potree_nogui$classdecl$var12.prototype,{neighbourCount:{configurable:!0,enumerable:!0,get:function(){return this._neighbourCount},set:function(a){if(this._neighbourCount!==a){this._neighbourCount=a;this.neighbours=new Float32Array(2*this._neighbourCount);for(a=0;a<this._neighbourCount;a++)this.neighbours[2*a]=Math.cos(2*a*Math.PI/this._neighbourCount),this.neighbours[2*a+1]=Math.sin(2*a*Math.PI/this._neighbourCount);this.updateShaderSource()}}}});
Potree.EyeDomeLightingMaterial=lib$potree$potree_nogui$classdecl$var12;var lib$potree$potree_nogui$classdecl$var13=function(a){a=THREE.ShaderMaterial.call(this)||this;a.setValues({uniforms:{near:{type:'f',value:0},far:{type:'f',value:0},screenWidth:{type:'f',value:0},screenHeight:{type:'f',value:0},map:{type:'t',value:null}},vertexShader:Potree.Shaders['blur.vs'],fragmentShader:Potree.Shaders['blur.fs']});return a};$jscomp.inherits(lib$potree$potree_nogui$classdecl$var13,THREE.ShaderMaterial);
Potree.BlurMaterial=lib$potree$potree_nogui$classdecl$var13;var lib$potree$potree_nogui$classdecl$var14=function(a){a=THREE.RawShaderMaterial.call(this)||this;a.setValues({uniforms:{uDepthMap:{type:'t',value:null},uWeightMap:{type:'t',value:null}},vertexShader:a.getDefines()+Potree.Shaders['normalize.vs'],fragmentShader:a.getDefines()+Potree.Shaders['normalize.fs']});return a};$jscomp.inherits(lib$potree$potree_nogui$classdecl$var14,THREE.RawShaderMaterial);
lib$potree$potree_nogui$classdecl$var14.prototype.getDefines=function(){return''};lib$potree$potree_nogui$classdecl$var14.prototype.updateShaderSource=function(){var a=this.getDefines()+Potree.Shaders['normalize.vs'],b=this.getDefines()+Potree.Shaders['normalize.fs'];this.setValues({vertexShader:a,fragmentShader:b});this.needsUpdate=!0};Potree.NormalizationMaterial=lib$potree$potree_nogui$classdecl$var14;
var lib$potree$potree_nogui$classdecl$var15=function(a){a=THREE.RawShaderMaterial.call(this)||this;a.setValues({uniforms:{screenWidth:{type:'f',value:0},screenHeight:{type:'f',value:0},edlStrength:{type:'f',value:1},radius:{type:'f',value:1},neighbours:{type:'2fv',value:[]},uEDLMap:{type:'t',value:null},uDepthMap:{type:'t',value:null},uWeightMap:{type:'t',value:null}},vertexShader:a.getDefines()+Potree.Shaders['normalize.vs'],fragmentShader:a.getDefines()+Potree.Shaders['normalize_and_edl.fs']});
a.neighbourCount=8;return a};$jscomp.inherits(lib$potree$potree_nogui$classdecl$var15,THREE.RawShaderMaterial);lib$potree$potree_nogui$classdecl$var15.prototype.getDefines=function(){return'#define NEIGHBOUR_COUNT '+this.neighbourCount+'\n'};
lib$potree$potree_nogui$classdecl$var15.prototype.updateShaderSource=function(){var a=this.getDefines()+Potree.Shaders['normalize.vs'],b=this.getDefines()+Potree.Shaders['normalize_and_edl.fs'];this.setValues({vertexShader:a,fragmentShader:b});this.uniforms.neighbours.value=this.neighbours;this.needsUpdate=!0};
$jscomp.global.Object.defineProperties(lib$potree$potree_nogui$classdecl$var15.prototype,{neighbourCount:{configurable:!0,enumerable:!0,get:function(){return this._neighbourCount},set:function(a){if(this._neighbourCount!==a){this._neighbourCount=a;this.neighbours=new Float32Array(2*this._neighbourCount);for(a=0;a<this._neighbourCount;a++)this.neighbours[2*a]=Math.cos(2*a*Math.PI/this._neighbourCount),this.neighbours[2*a+1]=Math.sin(2*a*Math.PI/this._neighbourCount);this.updateShaderSource()}}}});
Potree.NormalizationEDLMaterial=lib$potree$potree_nogui$classdecl$var15;function LRUItem(a){this.next=this.previous=null;this.node=a}function LRU(){this.last=this.first=null;this.items={};this.numPoints=this.elements=0}LRU.prototype.size=function(){return this.elements};LRU.prototype.contains=function(a){return null==this.items[a.id]};
...
var lib$potree$potree_nogui$classdecl$var16=function(){Potree.PointCloudTreeNode.call(this);this.children={};this.octree=this.sceneNode=null};$jscomp.inherits(lib$potree$potree_nogui$classdecl$var16,Potree.PointCloudTreeNode);lib$potree$potree_nogui$classdecl$var16.prototype.getNumPoints=function(){return this.geometryNode.numPoints};lib$potree$potree_nogui$classdecl$var16.prototype.isLoaded=function(){return!0};lib$potree$potree_nogui$classdecl$var16.prototype.isTreeNode=function(){return!0};
lib$potree$potree_nogui$classdecl$var16.prototype.isGeometryNode=function(){return!1};lib$potree$potree_nogui$classdecl$var16.prototype.getLevel=function(){return this.geometryNode.level};lib$potree$potree_nogui$classdecl$var16.prototype.getBoundingSphere=function(){return this.geometryNode.boundingSphere};lib$potree$potree_nogui$classdecl$var16.prototype.getBoundingBox=function(){return this.geometryNode.boundingBox};
lib$potree$potree_nogui$classdecl$var16.prototype.getChildren=function(){for(var a=[],b=0;8>b;b++)this.children[b]&&a.push(this.children[b]);return a};
lib$potree$potree_nogui$classdecl$var16.prototype.getPointsInBox=function(a){if(!this.sceneNode)return null;var b=this.geometryNode.buffer,c=b.offset('position'),d=b.stride,e=new DataView(b.data);a=(new THREE.Matrix4).getInverse(a.matrixWorld);a=(new THREE.Matrix4).multiplyMatrices(a,this.sceneNode.matrixWorld);for(var f=[],g=new THREE.Vector4,h=0;h<b.numElements;h++){var l=e.getFloat32(h*d+c+0,!0),k=e.getFloat32(h*d+c+4,!0),m=e.getFloat32(h*d+c+8,!0);g.set(l,k,m,1);g.applyMatrix4(a);-.5<g.x&&.5>
g.x&&-.5<g.y&&.5>g.y&&-.5<g.z&&.5>g.z&&(g.set(l,k,m,1).applyMatrix4(this.sceneNode.matrixWorld),f.push(new THREE.Vector3(g.x,g.y,g.z)))}return f};$jscomp.global.Object.defineProperties(lib$potree$potree_nogui$classdecl$var16.prototype,{name:{configurable:!0,enumerable:!0,get:function(){return this.geometryNode.name}}});Potree.PointCloudOctreeNode=lib$potree$potree_nogui$classdecl$var16;
...
Potree.PointCloudOctree.prototype.getFittedBoxGen=function $jscomp$generator$function(a){var c,d,e,f=this,g,h,l,k,m,n,p,w,r,q,u,z,A,t,v,y;return $jscomp.generator.createGenerator($jscomp$generator$function,function(x){switch(x.nextAddress){case 1:c=performance.now(),d=new THREE.Box3,e=(new THREE.Matrix4).getInverse(a.matrixWorld),g=$jscomp.makeIterator(f.visibleNodes),h=g.next();case 2:if(h.done)return A=d.getCenter().applyMatrix4(a.matrixWorld),t=new THREE.Object3D,t.position.copy(A),t.scale.copy(a.scale),
t.rotation.copy(a.rotation),v=(new THREE.Vector3).subVectors(d.max,d.min),t.scale.multiply(v),y=performance.now()-c,console.log('duration: ',y),x.yield(t,0);l=h.value;if(!l.sceneNode){x.jumpTo(3);break}k=l.geometryNode.buffer;m=k.offset('position');n=k.stride;p=new DataView(k.data);w=(new THREE.Matrix4).multiplyMatrices(e,l.sceneNode.matrixWorld);r=new THREE.Vector4;for(var B=0;B<k.numElements;B++)q=p.getFloat32(B*n+m+0,!0),u=p.getFloat32(B*n+m+4,!0),z=p.getFloat32(B*n+m+8,!0),r.set(q,u,z,1),r.applyMatrix4(w),
-.5<r.x&&.5>r.x&&-.5<r.y&&.5>r.y&&-.5<r.z&&.5>r.z&&d.expandByPoint(r);return x.yield(void 0,3);case 3:h=g.next(),x.jumpTo(2)}})};
...
k+l+0,!0),r=m.getFloat32(p*k+l+4,!0),q=m.getFloat32(p*k+l+8,!0);n.set(w,r,q,1);n.applyMatrix4(h);-.5<n.x&&.5>n.x&&-.5<n.y&&.5>n.y&&-.5<n.z&&.5>n.z&&d.expandByPoint(n)}}}e=d.getCenter().applyMatrix4(a.matrixWorld);b=new THREE.Object3D;b.position.copy(e);b.scale.copy(a.scale);b.rotation.copy(a.rotation);a=(new THREE.Vector3).subVectors(d.max,d.min);b.scale.multiply(a);c=performance.now()-c;console.log('duration: ',c);return b};
...
var lib$potree$potree_nogui$classdecl$var17=function(){this.octreeDir=this.url=null;this.spacing=0;this.pointAttributes=this.nodes=this.root=this.boundingBox=null;this.hierarchyStepSize=-1;this.loader=null};Potree.PointCloudOctreeGeometry=lib$potree$potree_nogui$classdecl$var17;
var lib$potree$potree_nogui$classdecl$var18=function(a,b,c){Potree.PointCloudTreeNode.call(this);this.id=Potree.PointCloudOctreeGeometryNode.IDCount++;this.name=a;this.index=parseInt(a.charAt(a.length-1));this.pcoGeometry=b;this.geometry=null;this.boundingBox=c;this.boundingSphere=c.getBoundingSphere(new THREE.Sphere);this.children={};this.numPoints=0;this.level=null;this.loaded=!1;this.oneTimeDisposeHandlers=[]};$jscomp.inherits(lib$potree$potree_nogui$classdecl$var18,Potree.PointCloudTreeNode);
lib$potree$potree_nogui$classdecl$var18.prototype.isGeometryNode=function(){return!0};lib$potree$potree_nogui$classdecl$var18.prototype.getLevel=function(){return this.level};lib$potree$potree_nogui$classdecl$var18.prototype.isTreeNode=function(){return!1};lib$potree$potree_nogui$classdecl$var18.prototype.isLoaded=function(){return this.loaded};lib$potree$potree_nogui$classdecl$var18.prototype.getBoundingSphere=function(){return this.boundingSphere};
lib$potree$potree_nogui$classdecl$var18.prototype.getBoundingBox=function(){return this.boundingBox};lib$potree$potree_nogui$classdecl$var18.prototype.getChildren=function(){for(var a=[],b=0;8>b;b++)this.children[b]&&a.push(this.children[b]);return a};
lib$potree$potree_nogui$classdecl$var18.prototype.getURL=function(){var a='',b=this.pcoGeometry.loader.version;b.equalOrHigher('1.5')?a=this.pcoGeometry.octreeDir+'/'+this.getHierarchyPath()+'/'+this.name:b.equalOrHigher('1.4')?a=this.pcoGeometry.octreeDir+'/'+this.name:b.upTo('1.3')&&(a=this.pcoGeometry.octreeDir+'/'+this.name);return a};
lib$potree$potree_nogui$classdecl$var18.prototype.getHierarchyPath=function(){for(var a='r/',b=this.pcoGeometry.hierarchyStepSize,c=this.name.substr(1),d=Math.floor(c.length/b),e=0;e<d;e++)a+=c.substr(e*b,b)+'/';return a=a.slice(0,-1)};lib$potree$potree_nogui$classdecl$var18.prototype.addChild=function(a){this.children[a.index]=a;a.parent=this};
lib$potree$potree_nogui$classdecl$var18.prototype.load=function(){!0===this.loading||!0===this.loaded||Potree.numNodesLoading>=Potree.maxNodesLoading||(this.loading=!0,Potree.numNodesLoading++,this.pcoGeometry.loader.version.equalOrHigher('1.5')?0===this.level%this.pcoGeometry.hierarchyStepSize&&this.hasChildren?this.loadHierachyThenPoints():this.loadPoints():this.loadPoints())};lib$potree$potree_nogui$classdecl$var18.prototype.loadPoints=function(){this.pcoGeometry.loader.load(this)};
lib$potree$potree_nogui$classdecl$var18.prototype.loadHierachyThenPoints=function(){var a=this;if(0===a.level%a.pcoGeometry.hierarchyStepSize){var b=a.pcoGeometry.octreeDir+'/'+a.getHierarchyPath()+'/'+a.name+'.hrc',c=Potree.XHRFactory.createXMLHttpRequest();c.open('GET',b,!0);c.responseType='arraybuffer';c.overrideMimeType('text/plain; charset=x-user-defined');c.onreadystatechange=function(){if(4===c.readyState)if(200===c.status||0===c.status){var d=c.response,e=new DataView(d),f=[],g=e.getUint8(0),
h=e.getUint32(1,!0);a.numPoints=h;f.push({children:g,numPoints:h,name:a.name});g=[];for(h=5;0<f.length;){for(var l=f.shift(),k=1,m=0;8>m;m++){if(0!==(l.children&k)){var n=l.name+m,p=e.getUint8(h),w=e.getUint32(h+1,!0);f.push({children:p,numPoints:w,name:n});g.push({children:p,numPoints:w,name:n});h+=5}k*=2}if(h===d.byteLength)break}d={};d[a.name]=a;e=a.pcoGeometry;for(f=0;f<g.length;f++)h=g[f].name,l=g[f].numPoints,n=parseInt(h.charAt(h.length-1)),k=h.substring(0,h.length-1),k=d[k],m=h.length-1,n=
Potree.POCLoader.createChildAABB(k.boundingBox,n),n=new Potree.PointCloudOctreeGeometryNode(h,e,n),n.level=m,n.numPoints=l,n.hasChildren=0<g[f].children,n.spacing=e.spacing/Math.pow(2,m),k.addChild(n),d[h]=n;a.loadPoints()}else console.log('Failed to load file! HTTP status: '+c.status+', file: '+b),Potree.numNodesLoading--};try{c.send(null)}catch(d){console.log('fehler beim laden der punktwolke: '+d)}}};lib$potree$potree_nogui$classdecl$var18.prototype.getNumPoints=function(){return this.numPoints};
lib$potree$potree_nogui$classdecl$var18.prototype.dispose=function(){if(this.geometry&&null!=this.parent){this.geometry.dispose();this.geometry=null;this.loaded=!1;for(var a=0;a<this.oneTimeDisposeHandlers.length;a++)(0,this.oneTimeDisposeHandlers[a])();this.oneTimeDisposeHandlers=[]}};Potree.PointCloudOctreeGeometryNode=lib$potree$potree_nogui$classdecl$var18;Potree.PointCloudOctreeGeometryNode.IDCount=0;Object.assign(Potree.PointCloudOctreeGeometryNode.prototype,THREE.EventDispatcher.prototype);
...
r=parseInt(p.charAt(p.length-1)),q=p.substring(0,p.length-1);q=a[q];var u=p.length-1;r=Potree.GreyhoundLoader.createChildAABB(q.boundingBox,r);r=new Potree.PointCloudGreyhoundGeometryNode(p,d,r,h.scale,h.offset);r.level=u;r.numPoints=w;r.hasChildren=0<b[e].children;r.spacing=d.spacing/Math.pow(2,u);q.addChild(r);a[p]=r}h.loadPoints()}else console.log('Failed to load file! HTTP status:',g.status,'file:',f)};try{g.send(null)}catch(l){console.log('fehler beim laden der punktwolke: '+l)}}};
...
var lib$potree$potree_nogui$classdecl$var19=function(a){var b=THREE.Object3D.call(this)||this;var c=new THREE.Texture;c.minFilter=THREE.LinearFilter;c.magFilter=THREE.LinearFilter;c=new THREE.SpriteMaterial({map:c,depthTest:!1,depthWrite:!1});b.material=c;b.sprite=new THREE.Sprite(c);b.add(b.sprite);b.borderThickness=4;b.fontface='Arial';b.fontsize=28;b.borderColor={r:0,g:0,b:0,a:1};b.backgroundColor={r:255,g:255,b:255,a:1};b.textColor={r:255,g:255,b:255,a:1};b.text='';b.setText(a);return b};
$jscomp.inherits(lib$potree$potree_nogui$classdecl$var19,THREE.Object3D);lib$potree$potree_nogui$classdecl$var19.prototype.setText=function(a){this.text!==a&&(this.text=a,this.update())};lib$potree$potree_nogui$classdecl$var19.prototype.setTextColor=function(a){this.textColor=a;this.update()};lib$potree$potree_nogui$classdecl$var19.prototype.setBorderColor=function(a){this.borderColor=a;this.update()};
lib$potree$potree_nogui$classdecl$var19.prototype.setBackgroundColor=function(a){this.backgroundColor=a;this.update()};
lib$potree$potree_nogui$classdecl$var19.prototype.update=function(){var a=document.createElement('canvas'),b=a.getContext('2d');b.font='Bold '+this.fontsize+'px '+this.fontface;var c=b.measureText(this.text).width,d=10+c+2*this.borderThickness,e=1.4*this.fontsize+2*this.borderThickness;b.canvas.width=d;b.canvas.height=e;b.font='Bold '+this.fontsize+'px '+this.fontface;b.fillStyle='rgba('+this.backgroundColor.r+','+this.backgroundColor.g+','+this.backgroundColor.b+','+this.backgroundColor.a+')';b.strokeStyle=
...
lib$potree$potree_nogui$classdecl$var19.prototype.roundRect=function(a,b,c,d,e,f){a.beginPath();a.moveTo(b+f,c);a.lineTo(b+d-f,c);a.quadraticCurveTo(b+d,c,b+d,c+f);a.lineTo(b+d,c+e-f);a.quadraticCurveTo(b+d,c+e,b+d-f,c+e);a.lineTo(b+f,c+e);a.quadraticCurveTo(b,c+e,b,c+e-f);a.lineTo(b,c+f);a.quadraticCurveTo(b,c,b+f,c);a.closePath();a.fill();a.stroke()};Potree.TextSprite=lib$potree$potree_nogui$classdecl$var19;
...
var lib$potree$potree_nogui$classdecl$var20=function(){var a=THREE.Object3D.call(this)||this;a.constructor.counter=void 0===a.constructor.counter?0:a.constructor.counter+1;a.name='Measure_'+a.constructor.counter;a.points=[];a._showDistances=!0;a._showCoordinates=!1;a._showArea=!1;a._closed=!0;a._showAngles=!1;a._showHeight=!1;a.maxMarkers=Number.MAX_SAFE_INTEGER;a.sphereGeometry=new THREE.SphereGeometry(.4,10,10);a.color=new THREE.Color(16711680);a.lengthUnit={code:'m'};a.spheres=[];a.edges=[];a.sphereLabels=
...
lib$potree$potree_nogui$classdecl$var20.prototype.getAngleBetweenLines=function(a,b,c){b=(new THREE.Vector3).subVectors(b.position,a.position);a=(new THREE.Vector3).subVectors(c.position,a.position);return b.angleTo(a)};lib$potree$potree_nogui$classdecl$var20.prototype.getAngle=function(a){return 3>this.points.length||a>=this.points.length?0:this.getAngleBetweenLines(this.points[a],0===a?this.points[this.points.length-1]:this.points[a-1],this.points[(a+1)%this.points.length])};
...
'\u00b2';this.areaLabel.setText(b)}};lib$potree$potree_nogui$classdecl$var20.prototype.raycast=function(a,b){for(var c=0;c<this.points.length;c++)this.spheres[c].raycast(a,b);for(c=0;c<b.length;c++){var d=b[c];d.distance=a.ray.origin.distanceTo(d.point)}b.sort(function(a,b){return a.distance-b.distance})};
$jscomp.global.Object.defineProperties(lib$potree$potree_nogui$classdecl$var20.prototype,{showCoordinates:{configurable:!0,enumerable:!0,get:function(){return this._showCoordinates},set:function(a){this._showCoordinates=a;this.update()}},showAngles:{configurable:!0,enumerable:!0,get:function(){return this._showAngles},set:function(a){this._showAngles=a;this.update()}},showHeight:{configurable:!0,enumerable:!0,get:function(){return this._showHeight},set:function(a){this._showHeight=a;this.update()}},
showArea:{configurable:!0,enumerable:!0,get:function(){return this._showArea},set:function(a){this._showArea=a;this.update()}},closed:{configurable:!0,enumerable:!0,get:function(){return this._closed},set:function(a){this._closed=a;this.update()}},showDistances:{configurable:!0,enumerable:!0,get:function(){return this._showDistances},set:function(a){this._showDistances=a;this.update()}}});Potree.Measure=lib$potree$potree_nogui$classdecl$var20;
...
var lib$potree$potree_nogui$classdecl$var21=function(a){a=void 0===a?{}:a;a=Potree.Volume.call(this,a)||this;a.constructor.counter=void 0===a.constructor.counter?0:a.constructor.counter+1;a.name='box_'+a.constructor.counter;var b=new THREE.BoxGeometry(1,1,1);b.computeBoundingBox();var c=new THREE.Geometry;c.vertices.push(new THREE.Vector3(-.5,-.5,.5));c.vertices.push(new THREE.Vector3(.5,-.5,.5));c.vertices.push(new THREE.Vector3(.5,-.5,.5));c.vertices.push(new THREE.Vector3(.5,-.5,-.5));c.vertices.push(new THREE.Vector3(.5,
-.5,-.5));c.vertices.push(new THREE.Vector3(-.5,-.5,-.5));c.vertices.push(new THREE.Vector3(-.5,-.5,-.5));c.vertices.push(new THREE.Vector3(-.5,-.5,.5));c.vertices.push(new THREE.Vector3(-.5,.5,.5));c.vertices.push(new THREE.Vector3(.5,.5,.5));c.vertices.push(new THREE.Vector3(.5,.5,.5));c.vertices.push(new THREE.Vector3(.5,.5,-.5));c.vertices.push(new THREE.Vector3(.5,.5,-.5));c.vertices.push(new THREE.Vector3(-.5,.5,-.5));c.vertices.push(new THREE.Vector3(-.5,.5,-.5));c.vertices.push(new THREE.Vector3(-.5,
...
a.material);a.box.geometry.computeBoundingBox();a.boundingBox=a.box.geometry.boundingBox;a.add(a.box);a.frame=new THREE.LineSegments(c,new THREE.LineBasicMaterial({color:0}));a.add(a.frame);a.update();return a};$jscomp.inherits(lib$potree$potree_nogui$classdecl$var21,Potree.Volume);
lib$potree$potree_nogui$classdecl$var21.prototype.update=function(){this.boundingBox=this.box.geometry.boundingBox;this.boundingSphere=this.boundingBox.getBoundingSphere(new THREE.Sphere);this._clip?(this.box.visible=!1,this.label.visible=!1):(this.box.visible=!0,this.label.visible=this.showVolumeLabel)};lib$potree$potree_nogui$classdecl$var21.prototype.raycast=function(a,b){var c=[];this.box.raycast(a,c);0<c.length&&(a=c[0],b.push({distance:a.distance,object:this,point:a.point.clone()}))};
lib$potree$potree_nogui$classdecl$var21.prototype.getVolume=function(){return Math.abs(this.scale.x*this.scale.y*this.scale.z)};Potree.BoxVolume=lib$potree$potree_nogui$classdecl$var21;
var lib$potree$potree_nogui$classdecl$var22=function(a){a=void 0===a?{}:a;a=Potree.Volume.call(this,a)||this;a.constructor.counter=void 0===a.constructor.counter?0:a.constructor.counter+1;a.name='sphere_'+a.constructor.counter;var b=new THREE.SphereGeometry(1,32,32);b.computeBoundingBox();a.material=new THREE.MeshBasicMaterial({color:65280,transparent:!0,opacity:.3,depthTest:!0,depthWrite:!1});a.sphere=new THREE.Mesh(b,a.material);a.sphere.visible=!1;a.sphere.geometry.computeBoundingBox();a.boundingBox=
...
64,g=Math.cos(h),h=Math.sin(h),k=Math.sqrt(1-f*f),m=new THREE.Vector3(Math.cos(m)*k,Math.sin(m)*k,f),c.vertices.push(m),g=new THREE.Vector3(g*k,h*k,f),c.vertices.push(g);a.frame=new THREE.LineSegments(c,new THREE.LineBasicMaterial({color:0}));a.add(a.frame);c=new THREE.MeshBasicMaterial({wireframe:!0,color:0});a.frame=new THREE.Mesh(b,c);a.update();return a};$jscomp.inherits(lib$potree$potree_nogui$classdecl$var22,Potree.Volume);
lib$potree$potree_nogui$classdecl$var22.prototype.update=function(){this.boundingBox=this.sphere.geometry.boundingBox;this.boundingSphere=this.boundingBox.getBoundingSphere(new THREE.Sphere)};lib$potree$potree_nogui$classdecl$var22.prototype.raycast=function(a,b){var c=[];this.sphere.raycast(a,c);0<c.length&&(a=c[0],b.push({distance:a.distance,object:this,point:a.point.clone()}))};lib$potree$potree_nogui$classdecl$var22.prototype.getVolume=function(){return 4/3*Math.PI*this.scale.x*this.scale.y*this.scale.z};
Potree.SphereVolume=lib$potree$potree_nogui$classdecl$var22;
...
lib$potree$potree_nogui$classdecl$var27.toString=function(a){a instanceof Array||(a=[a]);a=a.filter(function(a){return a instanceof Potree.Measure});var b=[];a=$jscomp.makeIterator(a);for(var c=a.next();!c.done;c=a.next())c=Potree.GeoJSONExporter.measurementToFeatures(c.value),b=b.concat(c);return JSON.stringify({type:'FeatureCollection',features:b},null,'\t')};Potree.GeoJSONExporter=lib$potree$potree_nogui$classdecl$var27;var lib$potree$potree_nogui$classdecl$var28=function(){};
lib$potree$potree_nogui$classdecl$var28.measurementPointSection=function(a){return(a=a.points[0].position)?'0\nCIRCLE\n8\nlayer_point\n10\n'+a.x+'\n20\n'+a.y+'\n30\n'+a.z+'\n40\n1.0\n':''};
lib$potree$potree_nogui$classdecl$var28.measurementPolylineSection=function(a){var b=8;a.closed&&(b+=1);b='0\nPOLYLINE\n8\nlayer_polyline\n62\n1\n66\n1\n10\n0.0\n20\n0.0\n30\n0.0\n70\n'+b+'\n';a=$jscomp.makeIterator(a.points);for(var c=a.next();!c.done;c=a.next())c=c.value,c=c.position,b+='0\nVERTEX\n8\n0\n10\n'+c.x+'\n20\n'+c.y+'\n30\n'+c.z+'\n70\n32\n';return b+'0\nSEQEND\n'};
lib$potree$potree_nogui$classdecl$var28.measurementSection=function(a){if(0===a.points.length)return'';if(1===a.points.length)return Potree.DXFExporter.measurementPointSection(a);if(2<=a.points.length)return Potree.DXFExporter.measurementPolylineSection(a)};
lib$potree$potree_nogui$classdecl$var28.toString=function(a){a instanceof Array||(a=[a]);a=a.filter(function(a){return a instanceof Potree.Measure});var b=a.filter(function(a){return a instanceof Potree.Measure}).map(function(a){return a.points}).reduce(function(a,b){return a.concat(b)}).map(function(a){return a.position}),c=new THREE.Vector3(Infinity,Infinity,Infinity),d=new THREE.Vector3(-Infinity,-Infinity,-Infinity);b=$jscomp.makeIterator(b);for(var e=b.next();!e.done;e=b.next())e=e.value,c.min(e),
d.max(e);c='999\nDXF created from potree\n0\nSECTION\n2\nHEADER\n9\n$ACADVER\n1\nAC1006\n9\n$INSBASE\n10\n0.0\n20\n0.0\n30\n0.0\n9\n$EXTMIN\n10\n'+c.x+'\n20\n'+c.y+'\n30\n'+c.z+'\n9\n$EXTMAX\n10\n'+d.x+'\n20\n'+d.y+'\n30\n'+d.z+'\n0\nENDSEC\n';d='0\nSECTION\n2\nENTITIES\n';a=$jscomp.makeIterator(a);for(b=a.next();!b.done;b=a.next())d+=Potree.DXFExporter.measurementSection(b.value);return c+(d+'0\nENDSEC\n')+'0\nEOF'};Potree.DXFExporter=lib$potree$potree_nogui$classdecl$var28;
var lib$potree$potree_nogui$classdecl$var29=function(){};
lib$potree$potree_nogui$classdecl$var29.toString=function(a){var b='',c=Object.keys(a.data).filter(function(a){return'normal'!==a}).sort(function(a,b){if('position'===a)return-1;if('position'===b)return 1;if('color'===a)return-1;if('color'===b)return 1});b=[];for(var d=$jscomp.makeIterator(c),e=d.next();!e.done;e=d.next()){var f=e.value,g=a.data[f].length/a.numPoints;if('position'===f)b=b.concat(['x','y','z']);else if('color'===f)b=b.concat(['r','g','b','a']);else if(1<g)for(e=0;e<g;e++)b.push(f+
'_'+e);else b.push(f)}b=b.join(', ')+'\n';for(d=0;d<a.numPoints;d++){f=[];g=$jscomp.makeIterator(c);for(e=g.next();!e.done;e=g.next()){e=e.value;var h=a.data[e].length/a.numPoints;e=a.data[e].subarray(h*d,h*d+h).join(', ');f.push(e)}b+=f.join(', ')+'\n'}return b};Potree.CSVExporter=lib$potree$potree_nogui$classdecl$var29;var lib$potree$potree_nogui$classdecl$var30=function(){};
lib$potree$potree_nogui$classdecl$var30.toLAS=function(a){var b=a.boundingBox,c=b.min.clone(),d=b.min.distanceTo(b.max),e=new THREE.Vector3(.001,.001,.001);e=1E6<d?new THREE.Vector3(.01,.01,.01):new THREE.Vector3(.001,.001,.001);var f=function(a,b,c){c=new Uint8Array(c);for(var d=0;d<a.length;d++){var e=a.charCodeAt(d);c[b+d]=e}};d=new ArrayBuffer(227+28*a.numPoints);var g=new DataView(d),h=new Uint8Array(d);f('LASF',0,d);h[24]=1;h[25]=2;f('Potree 1.5',58,d);g.setUint16(94,227,!0);g.setUint32(96,
...
g.setUint16(b+22,255*a.data.color[4*f+1],!0),g.setUint16(b+24,255*a.data.color[4*f+2],!0));b+=28}return d};Potree.LASExporter=lib$potree$potree_nogui$classdecl$var30;var lib$potree$potree_nogui$classdecl$var31=function(){Potree.PointCloudTreeNode.call(this);this.kdtree=this.sceneNode=this.right=this.left=null};$jscomp.inherits(lib$potree$potree_nogui$classdecl$var31,Potree.PointCloudTreeNode);lib$potree$potree_nogui$classdecl$var31.prototype.getNumPoints=function(){return this.geometryNode.numPoints};
lib$potree$potree_nogui$classdecl$var31.prototype.isLoaded=function(){return!0};lib$potree$potree_nogui$classdecl$var31.prototype.isTreeNode=function(){return!0};lib$potree$potree_nogui$classdecl$var31.prototype.isGeometryNode=function(){return!1};lib$potree$potree_nogui$classdecl$var31.prototype.getLevel=function(){return this.geometryNode.level};lib$potree$potree_nogui$classdecl$var31.prototype.getBoundingSphere=function(){return this.geometryNode.boundingSphere};
lib$potree$potree_nogui$classdecl$var31.prototype.getBoundingBox=function(){return this.geometryNode.boundingBox};lib$potree$potree_nogui$classdecl$var31.prototype.toTreeNode=function(a){var b=null;this.left===a?b=this.left:this.right===a&&(b=this.right);if(b.loaded){a=new Potree.PointCloudArena4DNode;var c=THREE.PointCloud(b.geometry,this.kdtree.material);c.visible=!1;a.kdtree=this.kdtree;a.geometryNode=b;a.sceneNode=c;a.parent=this;a.left=this.geometryNode.left;a.right=this.geometryNode.right}};
lib$potree$potree_nogui$classdecl$var31.prototype.getChildren=function(){var a=[];this.left&&a.push(this.left);this.right&&a.push(this.right);return a};Potree.PointCloudArena4DNode=lib$potree$potree_nogui$classdecl$var31;
var lib$potree$potree_nogui$classdecl$var32=function(a){var b=Potree.PointCloudTree.call(this)||this;b.root=null;a.root?b.root=a.root:a.addEventListener('hierarchy_loaded',function(){b.root=a.root});b.visiblePointsTarget=2E6;b.minimumNodePixelSize=150;b.position.sub(a.offset);b.updateMatrix();b.numVisibleNodes=0;b.numVisiblePoints=0;b.boundingBoxNodes=[];b.loadQueue=[];b.visibleNodes=[];b.pcoGeometry=a;b.boundingBox=b.pcoGeometry.boundingBox;b.boundingSphere=b.pcoGeometry.boundingSphere;b.material=
new Potree.PointCloudMaterial({vertexColors:THREE.VertexColors,size:.05,treeType:Potree.TreeType.KDTREE});b.material.sizeType=Potree.PointSizeType.ATTENUATED;b.material.size=.05;b.profileRequests=[];b.name='';return b};$jscomp.inherits(lib$potree$potree_nogui$classdecl$var32,Potree.PointCloudTree);lib$potree$potree_nogui$classdecl$var32.prototype.getBoundingBoxWorld=function(){this.updateMatrixWorld(!0);return Potree.utils.computeTransformedBoundingBox(this.boundingBox,this.matrixWorld)};
lib$potree$potree_nogui$classdecl$var32.prototype.setName=function(a){this.name!==a&&(this.name=a,this.dispatchEvent({type:'name_changed',name:a,pointcloud:this}))};lib$potree$potree_nogui$classdecl$var32.prototype.getName=function(){return this.name};lib$potree$potree_nogui$classdecl$var32.prototype.getLevel=function(){return this.level};
lib$potree$potree_nogui$classdecl$var32.prototype.toTreeNode=function(a,b){var c=this,d=new Potree.PointCloudArena4DNode,e=new THREE.Points(a.geometry,this.material);e.frustumCulled=!1;e.onBeforeRender=function(b,e,h,l,k,m){k.program&&(b.getContext().useProgram(k.program.program),k.program.getUniforms().map.level&&(e=a.getLevel(),k.uniforms.level.value=e,k.program.getUniforms().map.level.setValue(b.getContext(),e)),c.visibleNodeTextureOffsets&&k.program.getUniforms().map.vnStart&&(e=c.visibleNodeTextureOffsets.get(d),
...
b.left===d?b.left=a:b.right===d&&(b.right=a)});return d};lib$potree$potree_nogui$classdecl$var32.prototype.updateMaterial=function(a,b,c,d){a.fov=Math.PI/180*c.fov;a.screenWidth=d.domElement.clientWidth;a.screenHeight=d.domElement.clientHeight;a.spacing=this.pcoGeometry.spacing;a.near=c.near;a.far=c.far;this.maxLevel>a.levels&&(a.levels=this.maxLevel+2);b=this.boundingBox.getSize(new THREE.Vector3);a.bbSize=[b.x,b.y,b.z]};lib$potree$potree_nogui$classdecl$var32.prototype.updateVisibleBounds=function(){};
lib$potree$potree_nogui$classdecl$var32.prototype.hideDescendants=function(a){for(var b=[],c=0;c<a.children.length;c++){var d=a.children[c];d.visible&&b.push(d)}for(;0<b.length;)for(a=b.shift(),a.visible=!1,a.boundingBoxNode&&(a.boundingBoxNode.visible=!1),c=0;c<a.children.length;c++)d=a.children[c],d.visible&&b.push(d)};
lib$potree$potree_nogui$classdecl$var32.prototype.updateMatrixWorld=function(a){!0===this.matrixAutoUpdate&&this.updateMatrix();if(!0===this.matrixWorldNeedsUpdate||!0===a)void 0===this.parent?this.matrixWorld.copy(this.matrix):this.matrixWorld.multiplyMatrices(this.parent.matrixWorld,this.matrix),this.matrixWorldNeedsUpdate=!1};
lib$potree$potree_nogui$classdecl$var32.prototype.nodesOnRay=function(a,b){var c=[];b=b.clone();for(var d=0;d<a.length;d++){var e=a[d],f=e.getBoundingSphere(new THREE.Sphere).clone().applyMatrix4(e.sceneNode.matrixWorld);b.intersectsSphere(f)&&c.push(e)}return c};
lib$potree$potree_nogui$classdecl$var32.prototype.pick=function(a,b,c,d){d=void 0===d?{}:d;var e=a.renderer,f=a.pRenderer;performance.mark('pick-start');var g=function(a,b){return void 0!==a?a:b};a=g(d.pickWindowSize,17);g(d.pickOutsideClipRegion,!1);var h=e.getSize(new THREE.Vector3),l=Math.ceil(g(d.width,h.width));h=Math.ceil(g(d.height,h.height));var k=g(d.pointSizeType,this.material.pointSizeType);g=g(d.pointSize,this.material.size);c=this.nodesOnRay(this.visibleNodes,c);if(0===c.length)return null;
if(!this.pickState){var m=new THREE.Scene,n=new Potree.PointCloudMaterial;n.pointColorType=Potree.PointColorType.POINT_INDEX;this.pickState={renderTarget:new THREE.WebGLRenderTarget(1,1,{minFilter:THREE.LinearFilter,magFilter:THREE.NearestFilter,format:THREE.RGBAFormat}),material:n,scene:m}}m=this.pickState;n=m.material;n.pointSizeType=k;n.shape=this.material.shape;n.size=g;n.uniforms.minSize.value=this.material.uniforms.minSize.value;n.uniforms.maxSize.value=this.material.uniforms.maxSize.value;
n.classification=this.material.classification;d.pickClipped?(n.clipBoxes=this.material.clipBoxes,n.clipTask=this.material.clipTask===Potree.ClipTask.HIGHLIGHT?Potree.ClipTask.NONE:this.material.clipTask):n.clipBoxes=[];this.updateMaterial(n,c,b,e);m.renderTarget.setSize(l,h);g=new THREE.Vector2(d.x,d.y);k=e.getContext();k.enable(k.SCISSOR_TEST);k.scissor(parseInt(g.x-(a-1)/2),parseInt(g.y-(a-1)/2),parseInt(a),parseInt(a));e.state.buffers.depth.setTest(n.depthTest);e.state.buffers.depth.setMask(n.depthWrite);
e.state.setBlending(THREE.NoBlending);e.clearTarget(m.renderTarget,!0,!0,!0);e.setRenderTarget(m.renderTarget);k.clearColor(0,0,0,0);e.clearTarget(m.renderTarget,!0,!0,!0);var p=this.material;this.material=n;f.renderOctree(this,c,b,m.renderTarget);this.material=p;b=parseInt(Math.min(Math.max(0,g.x-(a-1)/2),l));f=parseInt(Math.min(Math.max(0,g.y-(a-1)/2),h));l=parseInt(Math.min(b+a,l)-b);h=parseInt(Math.min(f+a,h)-f);l=new Uint8Array(4*l*h);k.readPixels(b,f,a,a,k.RGBA,k.UNSIGNED_BYTE,l);e.setRenderTarget(null);
...
'computeVisibilityTextureData-end'));return{data:b,offsets:c}};$jscomp.global.Object.defineProperties(lib$potree$potree_nogui$classdecl$var32.prototype,{progress:{configurable:!0,enumerable:!0,get:function(){return this.pcoGeometry.root?0<Potree.numNodesLoading?0:1:0}}});Potree.PointCloudArena4D=lib$potree$potree_nogui$classdecl$var32;
var lib$potree$potree_nogui$classdecl$var33=function(){this.pcoGeometry=this.number=this.boundingBox=this.right=this.left=null;this.loaded=!1;this.level=this.numPoints=0;this.children=[];this.oneTimeDisposeHandlers=[]};lib$potree$potree_nogui$classdecl$var33.prototype.isGeometryNode=function(){return!0};lib$potree$potree_nogui$classdecl$var33.prototype.isTreeNode=function(){return!1};lib$potree$potree_nogui$classdecl$var33.prototype.isLoaded=function(){return this.loaded};
lib$potree$potree_nogui$classdecl$var33.prototype.getBoundingSphere=function(){return this.boundingSphere};lib$potree$potree_nogui$classdecl$var33.prototype.getBoundingBox=function(){return this.boundingBox};lib$potree$potree_nogui$classdecl$var33.prototype.getChildren=function(){var a=[];this.left&&a.push(this.left);this.right&&a.push(this.right);return a};lib$potree$potree_nogui$classdecl$var33.prototype.getLevel=function(){return this.level};
lib$potree$potree_nogui$classdecl$var33.prototype.load=function(){if(!(this.loaded||this.loading||Potree.numNodesLoading>=Potree.maxNodesLoading)){this.loading=!0;Potree.numNodesLoading++;var a=this.pcoGeometry.url+'?node='+this.number,b=Potree.XHRFactory.createXMLHttpRequest();b.open('GET',a,!0);b.responseType='arraybuffer';var c=this;b.onreadystatechange=function(){if(4===b.readyState&&200===b.status){var a=b.response,e=new DataView(a);a=a.byteLength/17;var f=new ArrayBuffer(28*a);new DataView(f);
f=new Float32Array(3*a);for(var g=new Uint8Array(4*a),h=new Float32Array(a),l=new Uint8Array(a),k=new ArrayBuffer(4*a),m=new Uint32Array(k),n=new THREE.Box3,p=0;p<a;p++){var w=e.getFloat32(17*p,!0)+c.boundingBox.min.x,r=e.getFloat32(17*p+4,!0)+c.boundingBox.min.y,q=e.getFloat32(17*p+8,!0)+c.boundingBox.min.z,u=e.getUint8(17*p+12,!0),z=e.getUint8(17*p+13,!0),A=e.getUint8(17*p+14,!0),t=e.getUint8(17*p+15,!0),v=e.getUint8(17*p+16,!0);n.expandByPoint(new THREE.Vector3(w,r,q));f[3*p]=w;f[3*p+1]=r;f[3*
p+2]=q;g[4*p]=u;g[4*p+1]=z;g[4*p+2]=A;g[4*p+3]=255;h[p]=t;l[p]=v;m[p]=p}e=new THREE.BufferGeometry;e.addAttribute('position',new THREE.BufferAttribute(f,3));e.addAttribute('color',new THREE.BufferAttribute(g,4,!0));e.addAttribute('intensity',new THREE.BufferAttribute(h,1));e.addAttribute('classification',new THREE.BufferAttribute(l,1));f=new THREE.BufferAttribute(new Uint8Array(k),4,!0);e.addAttribute('indices',f);c.geometry=e;c.numPoints=a;c.loaded=!0;c.loading=!1;Potree.numNodesLoading--}};b.send(null)}};
lib$potree$potree_nogui$classdecl$var33.prototype.dispose=function(){if(this.geometry&&null!=this.parent){this.geometry.dispose();this.geometry=null;this.loaded=!1;for(var a=0;a<this.oneTimeDisposeHandlers.length;a++)(0,this.oneTimeDisposeHandlers[a])();this.oneTimeDisposeHandlers=[]}};lib$potree$potree_nogui$classdecl$var33.prototype.getNumPoints=function(){return this.numPoints};Potree.PointCloudArena4DGeometryNode=lib$potree$potree_nogui$classdecl$var33;
var lib$potree$potree_nogui$classdecl$var34=function(){var a=THREE.EventDispatcher.call(this)||this;a.numPoints=0;a.version=0;a.boundingBox=null;a.numNodes=0;a.name=null;a.provider=null;a.url=null;a.root=null;a.levels=0;a._spacing=null;a.pointAttributes=new Potree.PointAttributes(['POSITION_CARTESIAN','COLOR_PACKED']);return a};$jscomp.inherits(lib$potree$potree_nogui$classdecl$var34,THREE.EventDispatcher);
lib$potree$potree_nogui$classdecl$var34.load=function(a,b){var c=Potree.XHRFactory.createXMLHttpRequest();c.open('GET',a+'?info',!0);c.onreadystatechange=function(){try{if(4===c.readyState&&200===c.status){var d=JSON.parse(c.responseText),e=new Potree.PointCloudArena4DGeometry;e.url=a;e.name=d.Name;e.provider=d.Provider;e.numNodes=d.Nodes;e.numPoints=d.Points;e.version=d.Version;e.boundingBox=new THREE.Box3((new THREE.Vector3).fromArray(d.BoundingBox.slice(0,3)),(new THREE.Vector3).fromArray(d.BoundingBox.slice(3,
...
lib$potree$potree_nogui$classdecl$var34.prototype.loadHierarchy=function(){var a=this,b=this.url+'?tree',c=Potree.XHRFactory.createXMLHttpRequest();c.open('GET',b,!0);c.responseType='arraybuffer';c.onreadystatechange=function(){if(4===c.readyState&&200===c.status){var b=c.response,e=b.byteLength/3;b=new DataView(b);for(var f=[],g=null,h=0,l=0;l<e;l++){var k=b.getUint8(3*l,!0),m=0<(k&1),n=0<(k&2),p=0<(k&8),w=0<(k&16),r=null;0<(k&4)?r='X':p&&(r='Y');w&&(r='Z');k=new Potree.PointCloudArena4DGeometryNode;
k.hasLeft=m;k.hasRight=n;k.split=r;k.isLeaf=!m&&!n;k.number=l;k.left=null;k.right=null;k.pcoGeometry=a;k.level=f.length;h=Math.max(h,k.level);0<f.length?(m=f[f.length-1],k.boundingBox=m.boundingBox.clone(),n=m.boundingBox.getSize(new THREE.Vector3),m.hasLeft&&!m.left?(m.left=k,m.children.push(k),'X'===m.split?k.boundingBox.max.x=k.boundingBox.min.x+n.x/2:'Y'===m.split?k.boundingBox.max.y=k.boundingBox.min.y+n.y/2:'Z'===m.split&&(k.boundingBox.max.z=k.boundingBox.min.z+n.z/2),m=k.boundingBox.getCenter(),
n=k.boundingBox.getSize(new THREE.Vector3).length()/2,k.boundingSphere=new THREE.Sphere(m,n)):(m.right=k,m.children.push(k),'X'===m.split?k.boundingBox.min.x+=n.x/2:'Y'===m.split?k.boundingBox.min.y+=n.y/2:'Z'===m.split&&(k.boundingBox.min.z+=n.z/2),m=k.boundingBox.getCenter(),n=k.boundingBox.getSize(new THREE.Vector3).length()/2,k.boundingSphere=new THREE.Sphere(m,n))):(g=k,g.boundingBox=a.boundingBox.clone(),m=g.boundingBox.getCenter(),n=g.boundingBox.getSize(new THREE.Vector3).length()/2,g.boundingSphere=
new THREE.Sphere(m,n));m=k.boundingBox.getSize(new THREE.Vector3);k.spacing=(m.x+m.y+m.z)/3/75;k.estimatedSpacing=k.spacing;f.push(k);if(k.isLeaf)for(k=!1;!k&&0<f.length;)f.pop(),k=f[f.length-1],k=0<f.length&&k.hasRight&&null==k.right}a.root=g;a.levels=h;a.dispatchEvent({type:'hierarchy_loaded'})}};c.send(null)};
$jscomp.global.Object.defineProperties(lib$potree$potree_nogui$classdecl$var34.prototype,{spacing:{configurable:!0,enumerable:!0,get:function(){if(this._spacing)return this._spacing;if(this.root)return this.root.spacing},set:function(a){this._spacing=a}}});Potree.PointCloudArena4DGeometry=lib$potree$potree_nogui$classdecl$var34;var lib$potree$potree_nogui$classdecl$var35=function(a,b){this.gl=a;this.material=b;this.program=a.createProgram();this.recompile()};
lib$potree$potree_nogui$classdecl$var35.prototype.compileShader=function(a,b){var c=this.gl;a=c.createShader(a);c.shaderSource(a,b);c.compileShader(a);return c.getShaderParameter(a,c.COMPILE_STATUS)?a:(console.error('could not compile shader:'),c=c.getShaderInfoLog(a),console.error(c,b),null)};
lib$potree$potree_nogui$classdecl$var35.prototype.recompile=function(){var a=this.gl,b=this.compileShader(a.VERTEX_SHADER,this.material.vertexShader),c=this.compileShader(a.FRAGMENT_SHADER,this.material.fragmentShader);if(null!==b&&null!==c){var d=this.program;a.attachShader(d,b);a.attachShader(d,c);a.linkProgram(d);if(a.getProgramParameter(d,a.LINK_STATUS)){a.detachShader(d,b);a.detachShader(d,c);a.deleteShader(b);a.deleteShader(c);a.useProgram(d);b={};c=a.getProgramParameter(d,a.ACTIVE_UNIFORMS);
for(var e=0;e<c;e++){var f=a.getActiveUniform(d,e).name,g=a.getUniformLocation(d,f);b[f]=g}this.uniforms=b}else console.error('could not compile/link program:'),console.error(this.material.vertexShader),console.error(this.material.fragmentShader)}};Potree.GLProgram=lib$potree$potree_nogui$classdecl$var35;var lib$potree$potree_nogui$classdecl$var36=function(a,b,c,d,e){this.name=a;this.bytes=b;this.numElements=c;this.normalized=e;this.type=d};Potree.InterleavedBufferAttribute=lib$potree$potree_nogui$classdecl$var36;
var lib$potree$potree_nogui$classdecl$var37=function(a,b,c){this.data=a;this.attributes=b;this.stride=b.reduce(function(a,b){return a+b.bytes},0);this.stride=4*Math.ceil(this.stride/4);this.numElements=c};lib$potree$potree_nogui$classdecl$var37.prototype.offset=function(a){for(var b=0,c=$jscomp.makeIterator(this.attributes),d=c.next();!d.done;d=c.next()){d=d.value;if(d.name===a)return b;b+=d.bytes}return null};Potree.InterleavedBuffer=lib$potree$potree_nogui$classdecl$var37;
...
b=a.readUInt32LE(4);console.log('offsetToFirstIFD',b);var c=[],k=b;for(b=0;100>b;){console.log('currentIFDOffset',k);var m=a.readUInt16LE(k),q=a.readUInt32LE(k+2+12*m);console.log('next offset: ',k+2+12*m);k=a.slice(k+2,k+2+12*m);for(var u=0;u<m;u++){var z=f.fromValue(k.readUInt16LE(12*u)),A=e.fromValue(k.readUInt16LE(12*u+2)),t=k.readUInt32LE(12*u+4),v=k.readUInt32LE(12*u+8),y=A.bytes*t,x=void 0;4>=y?x=v:(x=new Uint8Array(y),x.set(a.slice(v,v+y)),x=new (g.get(A))(x.buffer),A===e.ASCII&&(x=String.fromCharCode.apply(String,
$jscomp.arrayFromIterable(x))));z=new h(z,A,t,v,x);c.push(z)}console.log('nextIFDOffset',q);if(0===q)break;k=q;b++}k=function(a){for(var b=$jscomp.makeIterator(c),d=b.next();!d.done;d=b.next())if(d=d.value,d.tag===a)return d;return null};b=k(f.IMAGE_WIDTH,c).value;m=k(f.IMAGE_HEIGHT,c).value;k(f.COMPRESSION,c);q=k(f.ROWS_PER_STRIP,c).value;A=k(f.STRIP_OFFSETS,c);z=k(f.STRIP_BYTE_COUNTS,c);k=Math.ceil(m/q);u=[];for(t=0;t<z.count;t++)v=z.type,y=z.offset+t*v.bytes,x=void 0,v===e.SHORT?x=a.readUInt16LE(y):
v===e.LONG&&(x=a.readUInt32LE(y)),u.push(x);z=[];for(t=0;t<A.count;t++)v=A.type,y=A.offset+t*v.bytes,x=void 0,v===e.SHORT?x=a.readUInt16LE(y):v===e.LONG&&(x=a.readUInt32LE(y)),z.push(x);A=new Uint8Array(b*m*3);for(v=t=0;v<k;v++){y=z[v];y=a.slice(y,y+u[v]);x=3*b;for(var B=0;B<q;B++){var C=y.slice(B*x,B*x+x);A.set(C,t*x);if(C.length===x)t++;else break}}console.log('width: '+b);console.log('height: '+m);console.log('numStrips: '+k);console.log('stripByteCounts',u.join(', '));console.log('stripOffsets',
...
$jscomp.arrayFromIterable(b.ifdEntries));var l=12*k.length+14,m=new Map;b=new Map;for(var n=$jscomp.makeIterator(k),t=n.next();!t.done;t=n.next()){t=t.value;var v=new ArrayBuffer(12),y=new DataView(v);y.setUint16(0,t.tag.value,!0);y.setUint16(2,t.type.value,!0);y.setUint32(4,t.count,!0);1===t.count&&4>=t.type.bytes?y.setUint32(8,t.value,!0):(y.setUint32(8,l,!0),y=new Uint8Array(t.count*t.type.bytes),t.type===e.ASCII?y.set(new Uint8Array(t.value.split('').map(function(a){return a.charCodeAt(0)}))):
y.set(new Uint8Array(t.value.buffer)),b.set(t.tag,y),l+=y.byteLength);m.set(t.tag,v)}(new DataView(m.get(f.STRIP_OFFSETS))).setUint32(8,l,!0);l=function(a){var b=a.reduce(function(a,b){return a+b.byteLength},0);b=new Uint8Array(b);var c=0;a=$jscomp.makeIterator(a);for(var d=a.next();!d.done;d=a.next())d=d.value,b.set(new Uint8Array(d),c),c+=d.byteLength;return b};k=l([new Uint16Array([k.length])].concat($jscomp.arrayFromIterable(m.values()),[new Uint32Array([0])]));b=l([].concat($jscomp.arrayFromIterable(b.values())));
...
a;){var d=Math.floor((a+1)/2)-1,e=this.content[d];if(c>=this.scoreFunction(e))break;this.content[d]=b;this.content[a]=e;a=d}},sinkDown:function(a){for(var b=this.content.length,c=this.content[a],d=this.scoreFunction(c);;){var e=2*(a+1),f=e-1,g=null;if(f<b){var h=this.scoreFunction(this.content[f]);h<d&&(g=f)}e<b&&this.scoreFunction(this.content[e])<(null==g?d:h)&&(g=e);if(null==g)break;this.content[a]=this.content[g];this.content[g]=c;a=g}}};var PotreeObject=function(){var a=THREE.Mesh.call(this,new THREE.Geometry,new THREE.MeshBasicMaterial)||this;a.rotation.set(-Math.PI/2,0,0);a.frustumCulled=!1;a.pointclouds=[];a.minNodeSize=30;return a};$jscomp.inherits(PotreeObject,THREE.Mesh);PotreeObject.prototype.setPointBudget=function(a){Potree.pointBudget=a};
PotreeObject.prototype.onBeforeRender=function(a,b,c,d,e,f){Potree.pointLoadLimit=2*Potree.pointBudget;b=$jscomp.makeIterator(this.pointclouds);for(d=b.next();!d.done;d=b.next())d=d.value,d.showBoundingBox=!1,d.generateDEM=!1,d.minimumNodePixelSize=this.minNodeSize;Potree.updatePointClouds(this.pointclouds,c,a)};PotreeObject.prototype.add=function(a){a instanceof Potree.PointCloudTree&&this.pointclouds.push(a);THREE.Object3D.prototype.add.call(this,a)};
PotreeObject.prototype.getBoundingBox=function(){var a=new THREE.Box3;this.updateMatrixWorld(!0);for(var b=$jscomp.makeIterator(this.pointclouds),c=b.next();!c.done;c=b.next())c=c.value,c.updateMatrixWorld(!0),c=Potree.utils.computeTransformedBoundingBox(c.pcoGeometry.tightBoundingBox?c.pcoGeometry.tightBoundingBox:c.boundingBox,c.matrixWorld),a.union(c);return a};
PotreeObject.prototype.estimateHeightAt=function(a){for(var b=null,c=Infinity,d=$jscomp.makeIterator(this.pointclouds),e=d.next();!e.done;e=d.next())if(e=e.value,void 0!==e.root.geometryNode){var f=null,g=Infinity,h=a.clone().sub(e.position);h.z=0;h=new THREE.Ray(h,new THREE.Vector3(0,0,1));for(var l=[e.root];0<l.length;){var k=l.pop(),m=k.getBoundingBox();if(h.intersectBox(m)){m=k.geometryNode.mean.z+e.position.z+k.geometryNode.boundingBox.min.z;k.geometryNode.spacing<=g&&(f=m,g=k.geometryNode.spacing);
m=$jscomp.makeIterator(Object.keys(k.children));for(var n=m.next();!n.done;n=m.next())n=n.value,k.children[n].geometryNode&&l.push(k.children[n])}}if(null===b||g<c)b=f,c=g}return b};
