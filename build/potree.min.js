...
(f=m,g=k.geometryNode.spacing);m=$jscomp.makeIterator(Object.keys(k.children));for(var n=m.next();!n.done;n=m.next())n=n.value,k.children[n].geometryNode&&l.push(k.children[n])}}if(null===b||g<c)b=f,c=g}return b};Potree.Object=source$PotreeObject$classdecl$var38;Potree.XHRFactory={config:{withCredentials:!1,customHeaders:[{header:null,value:null}]},createXMLHttpRequest:function(){var a=new XMLHttpRequest;a.overrideMimeType('text/plain');if(this.config.customHeaders&&Array.isArray(this.config.customHeaders)&&0<this.config.customHeaders.length){var b=a.open,c=this.config.customHeaders;a.open=function(){b.apply(this,[].slice.call(arguments));c.forEach(function(b){b.header&&b.value&&a.setRequestHeader(b.header,b.value)})}}return a}};
