...
min:[c.min.x,c.min.y,c.min.z],max:[c.max.x,c.max.y,c.max.z],offset:d.toArray(),scale:this.scale,normalize:a.pcoGeometry.normalize};u.workerPool.runTask(y.GREYHOUND,function(b){b=b.data;var c=b.attributeBuffers,d=new THREE.Box3((new THREE.Vector3).fromArray(b.tightBoundingBox.min),(new THREE.Vector3).fromArray(b.tightBoundingBox.max)),e=new THREE.BufferGeometry,f;for(f in c){var m=c[f].buffer;parseInt(f)===x.POSITION_CARTESIAN?e.setAttribute('position',new THREE.BufferAttribute(new Float32Array(m),
3)):parseInt(f)===x.COLOR_PACKED?e.setAttribute('color',new THREE.BufferAttribute(new Uint8Array(m),4,!0)):parseInt(f)===x.INTENSITY?e.setAttribute('intensity',new THREE.BufferAttribute(new Float32Array(m),1)):parseInt(f)===x.CLASSIFICATION?e.setAttribute('classification',new THREE.BufferAttribute(new Uint8Array(m),1)):parseInt(f)===x.NORMAL_SPHEREMAPPED?e.setAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(f)===x.NORMAL_OCT16?e.setAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),
3)):parseInt(f)===x.NORMAL?e.setAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(f)===x.INDICES?(m=new THREE.BufferAttribute(new Uint8Array(m),4),m.normalized=!0,e.setAttribute('indices',m)):parseInt(f)===x.SPACING&&(m=new THREE.BufferAttribute(new Float32Array(m),1),e.setAttribute('spacing',m))}d.max.sub(d.min);d.min.set(0,0,0);a.numPoints=b.numPoints;a.geometry=e;a.mean=new THREE.Vector3(...b.mean);a.tightBoundingBox=d;a.loaded=!0;a.loading=!1;u.numNodesLoading--},b,
...
(new THREE.Vector3).fromArray(d.tightBoundingBox.max)),h=new THREE.BufferGeometry,l;for(l in e){var m=e[l].buffer;parseInt(l)===x.POSITION_CARTESIAN?h.setAttribute('position',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(l)===x.COLOR_PACKED?h.setAttribute('color',new THREE.BufferAttribute(new Uint8Array(m),4,!0)):parseInt(l)===x.INTENSITY?h.setAttribute('intensity',new THREE.BufferAttribute(new Float32Array(m),1)):parseInt(l)===x.CLASSIFICATION?h.setAttribute('classification',new THREE.BufferAttribute(new Uint8Array(m),
1)):parseInt(l)===x.NORMAL_SPHEREMAPPED?h.setAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(l)===x.NORMAL_OCT16?h.setAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(l)===x.NORMAL?h.setAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(l)===x.INDICES?(m=new THREE.BufferAttribute(new Uint8Array(m),4),m.normalized=!0,h.setAttribute('indices',m)):parseInt(l)===x.SPACING&&(m=new THREE.BufferAttribute(new Float32Array(m),
1),h.setAttribute('spacing',m))}k.max.sub(k.min);k.min.set(0,0,0);a.numPoints=b.data.buffer.byteLength/c.byteSize;a.geometry=h;a.mean=new THREE.Vector3(...d.mean);a.tightBoundingBox=k;a.loaded=!0;a.loading=!1;a.estimatedSpacing=d.estimatedSpacing;u.numNodesLoading--}},b,[b.buffer])}}var ka=[function(a){return{position:[a.getInt32(0,!0),a.getInt32(4,!0),a.getInt32(8,!0)],intensity:a.getUint16(12,!0),classification:a.getUint8(16,!0)}},function(a){return{position:[a.getInt32(0,!0),a.getInt32(4,!0),a.getInt32(8,
...
w=new Uint8Array(c.data.indices);d.setAttribute('position',new THREE.BufferAttribute(k,3));d.setAttribute('color',new THREE.BufferAttribute(h,4,!0));d.setAttribute('intensity',new THREE.BufferAttribute(l,1));d.setAttribute('classification',new THREE.BufferAttribute(m,1));d.setAttribute('returnNumber',new THREE.BufferAttribute(p,1));d.setAttribute('numberOfReturns',new THREE.BufferAttribute(n,1));d.setAttribute('pointSourceID',new THREE.BufferAttribute(q,1));d.setAttribute('indices',new THREE.BufferAttribute(w,
...
c.onmessage=function(b){var d=new THREE.BufferGeometry,e=b.data.numPoints,g=new Float32Array(b.data.position);d.setAttribute('position',new THREE.BufferAttribute(g,3));g=new Uint8Array(b.data.indices);d.setAttribute('indices',new THREE.BufferAttribute(g,4));b.data.color&&(g=new Uint8Array(b.data.color),d.setAttribute('color',new THREE.BufferAttribute(g,4,!0)));b.data.intensity&&(g=new Float32Array(b.data.intensity),d.setAttribute('intensity',new THREE.BufferAttribute(g,1)));b.data.classification&&
(g=new Uint8Array(b.data.classification),d.setAttribute('classification',new THREE.BufferAttribute(g,1)));b.data.returnNumber&&(g=new Uint8Array(b.data.returnNumber),d.setAttribute('returnNumber',new THREE.BufferAttribute(g,1)));b.data.numberOfReturns&&(g=new Uint8Array(b.data.numberOfReturns),d.setAttribute('numberOfReturns',new THREE.BufferAttribute(g,1)));b.data.pointSourceId&&(g=new Uint16Array(b.data.pointSourceId),d.setAttribute('pointSourceID',new THREE.BufferAttribute(g,1)));d.attributes.indices.normalized=
...
e=a.pointsCount,g=new Float32Array(c.data.position),k=new Uint8Array(c.data.color),h=new Float32Array(c.data.intensity),l=new Uint8Array(c.data.classification),m=new Uint8Array(c.data.returnNumber),p=new Uint8Array(c.data.numberOfReturns),n=new Uint16Array(c.data.pointSourceID),q=new Uint8Array(c.data.indices);d.setAttribute('position',new THREE.BufferAttribute(g,3));d.setAttribute('color',new THREE.BufferAttribute(k,4,!0));d.setAttribute('intensity',new THREE.BufferAttribute(h,1));d.setAttribute('classification',
new THREE.BufferAttribute(l,1));d.setAttribute('returnNumber',new THREE.BufferAttribute(m,1));d.setAttribute('numberOfReturns',new THREE.BufferAttribute(p,1));d.setAttribute('pointSourceID',new THREE.BufferAttribute(n,1));d.setAttribute('indices',new THREE.BufferAttribute(q,4));d.attributes.indices.normalized=!0;g=new THREE.Box3((new THREE.Vector3).fromArray(c.data.tightBoundingBox.min),(new THREE.Vector3).fromArray(c.data.tightBoundingBox.max));this.node.doneLoading(d,g,e,new THREE.Vector3(...c.data.mean));
...
new THREE.BufferGeometry;B.setAttribute('position',new THREE.BufferAttribute(k,3));B.setAttribute('color',new THREE.BufferAttribute(h,4,!0));B.setAttribute('intensity',new THREE.BufferAttribute(l,1));B.setAttribute('classification',new THREE.BufferAttribute(m,1));var D=new THREE.BufferAttribute(new Uint8Array(p),4,!0);B.setAttribute('indices',D);a.geometry=B;a.numPoints=f;a.loaded=!0;a.loading=!1;u.numNodesLoading--}catch(Oa){console.error('Potree: Exception thrown parsing points.',Oa),u.numNodesLoading--}};
...
k,g,0,0);a.enableVertexAttribArray(f)}a.bindBuffer(a.ARRAY_BUFFER,null);a.bindVertexArray(null)}fetchOctrees(){for(var a=[],b=[this];0<b.length;){var c=b.pop();c instanceof S?a.push(c):(c=c.children.filter(a=>a.visible),b.push(...c))}return{octrees:a}}renderNodes(a,b,c,e,d,f){a=a.getContext();b=b.material;d=d.matrixWorldInverse;var g=new THREE.Matrix4,k=new Float32Array(16),h;for(h of c)if(void 0===u.debug.allowedNodes||u.debug.allowedNodes.includes(h.name)){var l=h.sceneNode.matrixWorld;g.multiplyMatrices(d,
