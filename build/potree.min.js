...
a;){var d=Math.floor((a+1)/2)-1,e=this.content[d];if(c>=this.scoreFunction(e))break;this.content[d]=b;this.content[a]=e;a=d}},sinkDown:function(a){for(var b=this.content.length,c=this.content[a],d=this.scoreFunction(c);;){var e=2*(a+1),f=e-1,g=null;if(f<b){var h=this.scoreFunction(this.content[f]);h<d&&(g=f)}e<b&&this.scoreFunction(this.content[e])<(null==g?d:h)&&(g=e);if(null==g)break;this.content[a]=this.content[g];this.content[g]=c;a=g}}};var source$PotreeObject$classdecl$var38=function(){var a=THREE.Mesh.call(this,new THREE.Geometry,new THREE.MeshBasicMaterial)||this;a.rotation.set(-Math.PI/2,0,0);a.frustumCulled=!1;a.pointclouds=[];a.minNodeSize=30;return a};$jscomp.inherits(source$PotreeObject$classdecl$var38,THREE.Mesh);source$PotreeObject$classdecl$var38.prototype.setPointBudget=function(a){Potree.pointBudget=a};
source$PotreeObject$classdecl$var38.prototype.onBeforeRender=function(a,b,c,d,e,f){Potree.pointLoadLimit=2*Potree.pointBudget;b=$jscomp.makeIterator(this.pointclouds);for(d=b.next();!d.done;d=b.next())d=d.value,d.showBoundingBox=!1,d.generateDEM=!1,d.minimumNodePixelSize=this.minNodeSize;Potree.updatePointClouds(this.pointclouds,c,a)};source$PotreeObject$classdecl$var38.prototype.add=function(a){a instanceof Potree.PointCloudTree&&this.pointclouds.push(a);THREE.Object3D.prototype.add.call(this,a)};
source$PotreeObject$classdecl$var38.prototype.getBoundingBox=function(){var a=new THREE.Box3;this.updateMatrixWorld(!0);for(var b=$jscomp.makeIterator(this.pointclouds),c=b.next();!c.done;c=b.next())c=c.value,c.updateMatrixWorld(!0),c=Potree.utils.computeTransformedBoundingBox(c.pcoGeometry.tightBoundingBox?c.pcoGeometry.tightBoundingBox:c.boundingBox,c.matrixWorld),a.union(c);return a};
source$PotreeObject$classdecl$var38.prototype.estimateHeightAt=function(a){for(var b=null,c=Infinity,d=$jscomp.makeIterator(this.pointclouds),e=d.next();!e.done;e=d.next())if(e=e.value,void 0!==e.root.geometryNode){var f=null,g=Infinity,h=a.clone().sub(e.position);h.z=0;h=new THREE.Ray(h,new THREE.Vector3(0,0,1));for(var l=[e.root];0<l.length;){var k=l.pop(),m=k.getBoundingBox();if(h.intersectBox(m)){m=k.geometryNode.mean.z+e.position.z+k.geometryNode.boundingBox.min.z;k.geometryNode.spacing<=g&&
(f=m,g=k.geometryNode.spacing);m=$jscomp.makeIterator(Object.keys(k.children));for(var n=m.next();!n.done;n=m.next())n=n.value,k.children[n].geometryNode&&l.push(k.children[n])}}if(null===b||g<c)b=f,c=g}return b};Potree.Object=source$PotreeObject$classdecl$var38;
