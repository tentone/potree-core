...
import { Potree as Potree$2 } from 'Potree.js';
...
class PointCloudMaterial$1 extends THREE.RawShaderMaterial
{
	...
	{
		this.classificationTexture = PointCloudMaterial$1.generateClassificationTexture(this._classification);
...
class Shader
{
	...
	linkProgram()
	{
		...
		else
		{
			...
			for(var name of Object.keys(Potree$2.attributeLocations))
			{
				var location = Potree$2.attributeLocations[name];
