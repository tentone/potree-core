...
onmessage = function(event) 
{
	...
	const getExtractor = (name) => 
	{
		...
		if (type === 'signed') 
		{
			switch (size) 
			{
			case 1: return (p) => {return view.getInt8(p + offset);};
			case 2: return (p) => {return view.getInt16(p + offset, true);};
			case 4: return (p) => {return view.getInt32(p + offset, true);};
			case 8: return (p) => {return view.getInt64(p + offset, true);};
			}
		}
		if (type === 'unsigned') 
		{
			switch (size) 
			{
			case 1: return (p) => {return view.getUint8(p + offset);};
			case 2: return (p) => {return view.getUint16(p + offset, true);};
			case 4: return (p) => {return view.getUint32(p + offset, true);};
			case 8: return (p) => {return view.getUint64(p + offset, true);};
			}
		}
		if (type === 'float') 
		{
			switch (size) 
			{
			case 4: return (p) => {return view.getFloat32(p + offset, true);};
			case 8: return (p) => {return view.getFloat64(p + offset, true);};
			}
		}
