declare function CustomView(buffer: any): void;
declare class CustomView {
    constructor(buffer: any);
    buffer: any;
    u8: Uint8Array;
    getUint32: (i: any) => number;
    getUint16: (i: any) => number;
    getFloat32: (i: any) => number;
    getUint8: (i: any) => number;
}
declare function Version(version: any): void;
...
declare function PointAttribute(name: any, type: any, numElements: any): void;
...
declare namespace PointAttribute {
...
declare function PointAttributes(pointAttributes: any): void;
...
declare namespace PointAttributeNames {
...
declare namespace PointAttributeTypes {
